declare module "uxp/components" {
     ...
     * @export
     */
    export type IDataFunction = (max: number, lastPageToken: string, args?: any) => Promise<{ items: Array<any>, pageToken: string, total?: number }>;
...
declare module 'reactjs-videobg';